...
<body style="height: 549px">
    <form id="form1" runat="server">
        <asp:Button ID="btnReturn" runat="server" height="26" OnClick="btnReturn_Click" style="z-index: 1; left: 302px; position: absolute; bottom: 336px" Text="Return to Main Menu" />
        ...
        <asp:Button ID="btnCancel" runat="server" height="26px" style="z-index: 1; left: 182px; position: absolute; bottom: 336px" Text="Cancel" width="60px" OnClick="btnCancel_Click" />
