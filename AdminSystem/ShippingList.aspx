...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApplyfilter" runat="server" OnClick="btnApplyfilter_Click" style="z-index: 1; left: 31px; top: 584px; position: absolute; right: 746px;" Text="Apply Filter" />
        ...
        <p>
            <asp:Button ID="btnReturn" runat="server" OnClick="btnReturn_Click" style="z-index: 1; left: 408px; top: 584px; position: absolute" Text="Return to Main Menu" />
        </p>
    </form>
</body>
</html>
